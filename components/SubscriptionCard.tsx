          ...
          <View className='sub-details'>
            ...
            <View className='sub-row'>
              <View className='sub-row-copy'>
                ...
                <Text className='sub-value' numberOfLines={1} ellipsizeMode='tail'>{ formatSubscriptionDateTime(startDate) || '' }</Text>
              </View>
            </View>
            <View className='sub-row'>
              <View className='sub-row-copy'>
                <Text className='sub-label'>Renewal Date:</Text>
                <Text className='sub-value' numberOfLines={1} ellipsizeMode='tail'>{ formatSubscriptionDateTime(renewalDate) || '' }</Text>
              </View>
            </View>
            <View className='sub-row'>
              <View className='sub-row-copy'>
